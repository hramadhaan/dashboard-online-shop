...
const LoginPage: React.FC<LoginPageProps> = (props) => {
  ...
  return (
    <main className="flex h-screen w-full flex-col items-center justify-center">
      <div className="card bg-base-300 shadow-md md:w-2/6 w-11/12">
        <div className="card-body">
          <div className="card-title">Masuk</div>
          <p className="text-sm text-gray-500">Masukkan email dan password</p>
      ...
      <footer className="footer items-center p-4 bg-neutral text-neutral-content fixed bottom-0">
        ...
        <nav className="md:grid md:grid-flow-col md:gap-4 md:place-self-center md:justify-self-end hidden">
          <a>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
